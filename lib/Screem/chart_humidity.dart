...
class Humidity_Chart extends StatelessWidget {
  @override
    ...
    if (data.weather_fiveday.length == 0) {
      ...
      return LineChart(
        LineChartData(
          ...
          minY: 0,
          maxY: 10,
          titlesData: LineTitles_Humidity.getTitleData(),
          gridData: FlGridData(
            show: true,
          ...
          lineBarsData: [
            LineChartBarData(
              spots: [
                FlSpot(
                    0,
                    (data.weather_fiveday[1].main_fiveday.humidity.toDouble() /
                        10)),
                FlSpot(
                    1,
                    data.weather_fiveday[8].main_fiveday.humidity.toDouble() /
                        10),
                FlSpot(
                    2,
                    data.weather_fiveday[16].main_fiveday.humidity.toDouble() /
                        10),
                FlSpot(
                    3,
                    data.weather_fiveday[24].main_fiveday.humidity.toDouble() /
                        10),
                FlSpot(
                    4,
                    data.weather_fiveday[32].main_fiveday.humidity.toDouble() /
                        10),
                FlSpot(
                    5,
                    data.weather_fiveday[39].main_fiveday.humidity.toDouble() /
                        10),
              ],
              isCurved: true,
